...
<div style="height: 100%;width: 100%">
    <form name="query" class="form-inline" style="width:70%;height:10%;margin-left: 14%;padding-top:2%">
        <div class="form-group">
            <label>入库方式：</label><input type="text" name="query_line" id="query_line"
    ...
    <div style="width:70%;height:80%;margin:0 auto;">
        <div class="page-header" style="margin-top: 0;margin-bottom: 1%">
            <h3 style="margin-bottom: 0;margin-top: 0"><small>入库方式信息</small></h3>
        ...
        <div style="height: 85%">
            <table class="table table-hover" style="text-align: center">
                <tr>
                    <td class="tdStyle_title active" style="width: 35%">入库方式</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width:60%">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="title1">入库信息新增</h4>
                    <h4 class="modal-title" id="title2">入库信息修改</h4>
                </div>
                <div class="modal-body">
                    <div class="form-horizontal">
                        <div class="form-group" style="margin-top: 5%">
                            <label for="pop_line" style="width: 28%;text-align: left;padding-right: 0"
                                   class="col-sm-2 control-label">入库方式:</label>
