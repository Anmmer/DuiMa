...
<div style="height: 95%;width: 100%">
    ...
    <div style="width:70%;height:80%;margin:0 auto;">
        <div class="page-header" style="margin-top: 0;margin-bottom: 1%">
            ...
            <button type="button" style="position: absolute;right: 21%;top:10%" class="btn btn-primary btn-sm"
                    data-toggle="modal"
                    onclick="openAddPop(2)">
                新增名称
            </button>
        </div>
        <div style="height: 85%">
            <table class="table table-hover" style="text-align: center">
                <tr>
                    <td class='tdStyle_title active' style="width: 20%">分类</td>
