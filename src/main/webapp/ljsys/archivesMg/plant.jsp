...
<div style="height: 100%;width: 100%">
    <form name="query" class="form-inline" style="width:70%;height:10%;margin-left: 14%;padding-top:2%">
        <div class="form-group">
            <label>工厂名称：</label><input type="text" name="query_plant" id="query_plant"
    ...
    <div style="width:70%;height:80%;margin:0 auto;">
        ...
        <div style="height: 85%">
            <table class="table table-hover" style="text-align: center">
                <tr>
                    <td class="tdStyle_title active" style="width: 35%">工厂信息</td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" style="width:60%">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="title1">工厂新增</h4>
                        <h4 class="modal-title" id="title2">工厂修改</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-horizontal">
                            <div class="form-group" style="margin-top: 5%">
                                <label for="pop_plant" style="width: 28%;text-align: left;padding-right: 0"
                                       class="col-sm-2 control-label">工厂信息:</label>
                                <input type="text" class="form-control" style="width:50%;" id="pop_plant"
                                       name="pop_plant">
                            </div>
                        </div>
                    </div>
