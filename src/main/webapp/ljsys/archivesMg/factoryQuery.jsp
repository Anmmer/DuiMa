...
<div style="height: 100%;width: 100%">
    <form name="query" class="form-inline" style="width:70%;height:10%;margin-left: 14%;padding-top:2%">
        <div class="form-group">
            <label>仓库名称：</label><input type="text" name="query_planname" id="query_planname"
    ...
    <div style="width:70%;height:80%;margin:0 auto;">
        ...
        <div style="height: 85%">
            <table class="table table-hover" style="text-align: center">
                <tr>
                    <td class="tdStyle_title active" style="width: 35%">仓库信息</td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" style="width:60%">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="title1">仓库新增</h4>
                        <h4 class="modal-title" id="title2">仓库修改</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-horizontal">
                            <div class="form-group" style="margin-top: 5%">
                                <label for="pop_planname" style="width: 28%;text-align: left;padding-right: 0"
                                       class="col-sm-2 control-label">仓库信息:</label>
...
<script type="text/javascript">
    ...
    function edit(id) {
        ...
        $.post("${pageContext.request.contextPath}/UpdateFactory", obj, function (result) {
            result = JSON.parse(result);
            alert(result.message);
            if (result.flag) {
                $('#myModal').modal('hide');
