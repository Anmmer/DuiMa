...
<div style="height: 95%;width: 100%">
    <form name="query" class="form-inline" style="width:70%;height:10%;margin-left: 14%;padding-top:2%">
        <div class="form-group">
            <label>姓名：</label><input type="text" name="query_qc" id="query_qc"
    ...
    <div style="width:70%;height:80%;margin:0 auto;">
        <div class="page-header" style="margin-top: 0;margin-bottom: 1%">
            <h3 style="margin-bottom: 0;margin-top: 0"><small>质检员信息</small></h3>
        ...
        <div style="height: 85%">
            <table class="table table-hover" style="text-align: center">
                <tr>
                    <td class='tdStyle_title active' style="width: 20%">默认质检员</td>
                    <td class='tdStyle_title active'>质检员信息</td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" style="width:60%">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="title1">质检员新增</h4>
                        <h4 class="modal-title" id="title2">质检员修改</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-horizontal">
                            <div class="form-group" style="margin-top: 5%">
                                <label for="pop_qc" style="width: 28%;text-align: left;padding-right: 0"
                                       class="col-sm-2 control-label">质检员姓名:</label>
                                <input type="text" class="form-control" style="width:50%;" id="pop_qc"
                                       name="pop_qc">
                            </div>
                        </div>
                    </div>
