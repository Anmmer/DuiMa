    ...
    <div style="width:100%;height:90%;">
        ...
        <div style="width:70%;height:17%;margin:0 auto;">
            <form name="newGroup" id="newGroup">
                <span class="pStyle">新增群组名:</span><input type="text" id="newGroupName" name="newGroupName" style="font-size: 16px;font-family: Simsum;"><span class="pStyle">&nbsp;&nbsp;&nbsp;&nbsp;</span><button type="button" style="font-size: 16px;font-family: Simsun;" onclick="addGroup()">提交新增</button>
            </form>
        </div>
    </div>
    <!-- 查询所有群组 -->
