            ...
            if (flag) {
                for (let i = 0; i < jsonObj.length; i++) {
                    ...
                    str += "<tr><td class='tdStyle_body'><input type='checkbox' data-id=" + jsonObj[i]['materialcode'] + ">" +
                        ...
                        "</td><td class='tdStyle_body' title='" + jsonObj[i]['scrap_remark'] + "'>" + jsonObj[i]['scrap_remark'] +
                        "</td><td class='tdStyle_body' title='" + jsonObj[i]['scrap_in_user'] + "'>" + jsonObj[i]['scrap_in_user'] +
                        "</td></tr>";
                }
                ...
                for (let i = 0; i < pop_pageDate.length; i++) {
                    ...
                    str += "<tr><td class='tdStyle_body'><input type='checkbox' data-id=" + pop_pageDate[i]['materialcode'] + ">" +
                        ...
                        "</td><td class='tdStyle_body' title='" + pop_pageDate[i]['inspect_remark'] + "'>" + pop_pageDate[i]['inspect_remark'] +
                        "</td><td class='tdStyle_body' title='" + pop_pageDate[i]['inspect_user'] + "'>" + pop_pageDate[i]['inspect_user'] +
                        "</td></tr>";
                }
