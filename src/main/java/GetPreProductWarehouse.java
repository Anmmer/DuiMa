...
public class GetPreProductWarehouse extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            con = DbUtil.getCon();
            String sql = "select warehouse_name,materialname,preproductid,pourmade,inspect from warehouse,warehouse_info,preproduct where warehouse.warehouse_id = warehouse_info.warehouse_id and warehouse_info.product_id = preproduct.materialcode and  isdelete = 0";
