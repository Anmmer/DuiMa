...
public class ProductionUnit extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            con = DbUtil.getCon();
            String sql1 = "select name,id from component_production_unit where is_effective = 1";
            String sql1_page = "select count(*) as num from component_production_unit where is_effective = 1";
            String sql2 = "insert into component_production_unit values(?,?,now(),'1')";
            String sql3 = "update component_production_unit set ";
            if ("1".equals(type)) {
