...
public class GetPieData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            int j = 0;
            con = DbUtil.getCon();
            String sql = "select build_type name,sum(fangliang) value from build_table a left join preproduct b on a.materialcode = b.materialcode where b.pourmade = 1 and  a.planname = ?";
            String sql2 = "select build_type name,sum(fangliang) value from build_table a left join preproduct b on a.materialcode = b.materialcode where b.inspect = 1 and  a.planname = ?";
