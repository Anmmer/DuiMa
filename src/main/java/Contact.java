...
//        super.doGet(req, resp);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            con = DbUtil.getCon();
            String sql1 = "select name,id,phone from contact where is_effective = 1";
            String sql1_page = "select count(*) as num from contact where is_effective = 1";
            String sql2 = "insert into contact(id,name,phone,create_time,is_effective) values(?,?,?,now(),'1')";
            String sql3 = "update contact set ";
            if ("1".equals(type)) {
