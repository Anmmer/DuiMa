...
public class CementGrade extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            con = DbUtil.getCon();
            String sql1 = "select name,id from cement_grade where is_effective = 1";
            String sql1_page = "select count(*) as num from cement_grade where is_effective = 1";
            String sql2 = "insert into cement_grade values(?,?,now(),'1')";
            String sql3 = "update cement_grade set ";
            if ("1".equals(type)) {
